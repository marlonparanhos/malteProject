    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
         <li><a class="nav_roll" href="../index.php">Home</a></li>
          <li><a class="nav_roll" href="cardapio.php">Cardápio</a></li>
          <li><a class="nav_roll" href="../cadastro/formulario.php">Cadastro</a></li>
          <li><a class="nav_roll" href="../cadastro/perfil.php">Perfil</a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 wow fadeInLeft" data-wow-delay="1.5s">
          ...
          <a href="carrinho.php" type="button" class="btn btn-info btn-block">Adicionar ao carrinho</a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 wow fadeInLeft" data-wow-delay="0s">
          ...
          <h4>1795 Original Czech Lager</h4>
          <b>Viajou para Krypton</b>
          <p>Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos, e vem sendo utilizado desde o século XVI.</p>
          <a href="carrinho.php" type="button" class="btn btn-info btn-block">Adicionar ao carrinho</a>
        </div>
